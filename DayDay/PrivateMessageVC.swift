...
class PrivateMessageVC: UICollectionViewController, UITextFieldDelegate, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    lazy var inputContainerView: UIView = {
        ...
        separatorLineView.backgroundColor = UIColor(red:0.66, green:0.90, blue:0.83, alpha:1.0)
    ...
    func setupInputComponents() {
        ...
        let separatorLineView = UIView()
        separatorLineView.backgroundColor = UIColor(red:0.60, green:0.69, blue:0.98, alpha:1.0)
        separatorLineView.translatesAutoresizingMaskIntoConstraints = false
        containerView.addSubview(separatorLineView)
